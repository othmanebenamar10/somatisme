        ...
        <div className="container max-w-4xl">
          ...
          >
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed">
                Pour toute question concernant cette politique de confidentialité ou l'utilisation de vos données, vous pouvez nous contacter à : <span className="text-accent font-semibold">somatisme@gmail.com</span> ou par téléphone au <span className="text-accent font-semibold">06 79 82 56 46</span>.
              </p>
            </motion.div>
