...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "L'assurance qualité (AQ) est une approche proactive et systématique visant à garantir la conformité des produits ou services aux exigences définies, prévenant ainsi les défauts avant qu'ils ne surviennent. Elle structure les processus opérationnels, assure le respect des normes (ex: ISO 9001) et améliore la confiance client. Contrairement au contrôle qualité (QC) qui détecte les défauts sur le produit final, l'AQ se concentre sur l'amélioration des processus pour éviter les erreurs. Elle implique la définition de normes, la documentation, la formation du personnel et des audits continus.",
      category: 'Qualité',
      tech: 'ISO 9001, Audit qualité, Documentation process, Formation personnel, Tests logiciels',
