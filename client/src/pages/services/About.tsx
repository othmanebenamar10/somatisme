...
export default function About() {
  ...
  const partners = [
    { name: 'Procter & Gamble', url: 'https://www.pg.ma', desc: 'Leader mondial des produits de grande consommation.', logoUrl: '/logo-pg.png' },
    { name: 'Smart Strategies', url: 'https://www.smartstrategies.ma', desc: 'Société spécialisée dans l\'industrie de la sidérurgie.', logoUrl: '/logo-smart.png' },
    { name: 'Espace Metal', url: 'http://www.espacemetal.net/', desc: 'Chaudronnerie, charpente métallique et tuyauterie.', logoUrl: '/logo-espace-metal.png' },
    { name: 'Comaprom', url: '#', desc: 'Produits métallurgiques et industrie du tube soudé.', logoUrl: '/logo-comaprom.png' },
    { name: 'Electroprint', url: '#', desc: 'Solutions avancées de marquage et impression industrielle.', logoUrl: '/logo-electroprint.png' },
    { name: 'FATER', url: '#', desc: 'Partenaire industriel majeur en produits d’hygiène et santé.', logoUrl: '/logo-fater.png' },
  ];
