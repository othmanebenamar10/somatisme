          ...
          >
            ...
            <Link href="/contact">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white font-bold px-8 py-4 rounded-xl inline-flex items-center justify-center gap-2 min-h-48 shadow-lg shadow-cyan-500/30 text-lg px-10 py-5"
              >
                {t('cta.home.button')}
