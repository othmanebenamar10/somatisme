...
export default function Products() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <motion.a
        href="https://wa.me/212679825646?text=Bonjour%20SOMATISME%2C%20j%27aimerais%20avoir%20plus%20d%27informations%20sur%20vos%20produits%20et%20services."
        target="_blank"
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-8 right-8 z-40 w-16 h-16 rounded-full bg-gradient-to-br from-green-400 to-green-600 shadow-2xl shadow-green-500/50 flex items-center justify-center hover:shadow-green-500/70 transition-all group"
      >
        {/* Pulsing ring */}
        <motion.div
        ...
        {/* Tooltip */}
        <div className="absolute bottom-full right-0 mb-3 bg-gray-900 text-white text-xs font-bold px-3 py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
          {language === 'ar' ? 'تحدث معنا' : 'Contactez-nous'}
          <div className="absolute top-full right-2 w-2 h-2 bg-gray-900 rotate-45"></div>
        </div>
      </motion.a>
