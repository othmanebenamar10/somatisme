...
const products: Product[] = [
  {
    id: '1',
    name: 'Capteurs photoélectriques Retro-reflective  Range 10000mm, Power Supply 10.8-264',
    nameAr: 'Capteurs photoélectriques Retro-reflective  Range 10000mm, Power Supply 10.8-264',
    reference: 'PC50CNR10RP',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 165,
  ...
  {
    id: '2',
    name: 'Capteurs photoélectriques Retro-reflective  Power Supply 10-30VDC,',
    nameAr: 'Capteurs photoélectriques Retro-reflective  Power Supply 10-30VDC,',
    reference: 'PC50CNR10BA',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 132,
  ...
  {
    id: '3',
    name: 'Barrière lumineuse monofaisceau 4 fils',
    nameAr: 'Barrière lumineuse monofaisceau 4 fils',
    reference: 'Y7020V000',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 110,
  ...
  {
    id: '4',
    name: 'Boîte resine de jonction M 13/EG',
    nameAr: 'Boîte resine de jonction M 13/EG',
    reference: 'GC1360',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 440,
  ...
  {
    id: '5',
    name: 'LR-1/2-D-MIDI (159581) pressure regulator',
    nameAr: 'LR-1/2-D-MIDI (159581) pressure regulator',
    reference: 'OT-FESTO018646',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 165,
  ...
  {
    id: '6',
    name: 'INCREMENTAL ENCODER EN ALUMINIUM 5 V 0522631 -O 5 V DC IP64 /4096AK.42TD',
    nameAr: 'INCREMENTAL ENCODER EN ALUMINIUM 5 V 0522631 -O 5 V DC IP64 /4096AK.42TD',
    reference: 'O 522 631',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 220,
    image: '/products/image6.jpeg',
  ...
  {
    id: '7',
    name: 'Lampe de signalisation 12V',
    nameAr: 'Lampe de signalisation 12V',
    reference: '20133639',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 110,
  ...
  {
    id: '8',
    name: 'Interrupteur de déconnexion OT45E3 ABB',
    nameAr: 'Interrupteur de déconnexion OT45E3 ABB',
    reference: 'OT45E3/30A',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 1045,
    image: '/products/image8.jpeg',
  ...
  {
    id: '9',
    name: 'Crouzet 88886016 TIMER TMR 48U Relais temporisé multifonction 1 pc(s) Plage temp',
    nameAr: 'Crouzet 88886016 TIMER TMR 48U Relais temporisé multifonction 1 pc(s) Plage temp',
    reference: 'TIMER TMR 48U',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 330,
    image: '/products/image9.jpeg',
    description: 'Crouzet 88886016 TIMER TMR 48U Relais temporisé multifonction 1 pc(s) Plage temporelle: 0.02 s - 300 h 2 inverseurs (RT) NEW',
    descriptionAr: 'Crouzet 88886016 TIMER TMR 48U Relais temporisé multifonction 1 pc(s) Plage temporelle: 0.02 s - 300 h 2 inverseurs (RT) NEW',
    brand: 'Industriel',
    stock: 2,
    featured: false
  },
  {
    id: '10',
    name: 'Eaton Rotary disconnect main switch, Surface, 63 A, Red handle NEW',
    nameAr: 'Eaton Rotary disconnect main switch, Surface, 63 A, Red handle NEW',
    reference: 'P3-63/I4/SVB/HI11',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 550,
    image: '/products/image10.jpeg',
    description: 'Eaton Rotary disconnect main switch, Surface, 63 A, Red handle NEW',
    descriptionAr: 'Eaton Rotary disconnect main switch, Surface, 63 A, Red handle NEW',
    brand: 'Industriel',
    stock: 4,
    featured: false
  },
  {
    id: '11',
    name: 'Safety switch: key operated; MA150; NC + NO; IP65; plastic  NEW',
    nameAr: 'Safety switch: key operated; MA150; NC + NO; IP65; plastic  NEW',
    reference: 'MA150T83X11',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 280,
  ...
  {
    id: '12',
    name: 'CUTLER HAMMER 1775T-PMPP-1700 POWERMATE POWER PRO 92-01940-02 1775TPMPP1700  USE',
    nameAr: 'CUTLER HAMMER 1775T-PMPP-1700 POWERMATE POWER PRO 92-01940-02 1775TPMPP1700  USE',
    reference: '1775TPMPP1700',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 2200,
    image: '/products/image12.jpeg',
  ...
  {
    id: '13',
    name: 'Legrand Répartiteur modulaire tétrapolaire 125A NEW',
    nameAr: 'Legrand Répartiteur modulaire tétrapolaire 125A NEW',
    reference: 'Repartiteur Bipolaire 125 A',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 55,
  ...
  {
    id: '14',
    name: 'Disjoncteur de puissance Siemens SIRIUS 3RV2011-1GA10   4,5----6,3A  NEW',
    nameAr: 'Disjoncteur de puissance Siemens SIRIUS 3RV2011-1GA10   4,5----6,3A  NEW',
    reference: '3RV2011-1GA10',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 1257,
    image: '/products/image14.jpeg',
  ...
  {
    id: '15',
    name: 'Disjoncteur de puissance Siemens SIRIUS 3RV2011-1HA10  5,5-----8A',
    nameAr: 'Disjoncteur de puissance Siemens SIRIUS 3RV2011-1HA10  5,5-----8A',
    reference: '3RV2011-1HA10',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 1257,
  ...
  {
    id: '16',
    name: 'Disjoncteur de puissance Siemens SIRIUS 3RV2011-0JA10',
    nameAr: 'Disjoncteur de puissance Siemens SIRIUS 3RV2011-0JA10',
    reference: '3RV2011-0JA10',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 948,
    image: '/products/image16.jpeg',
  ...
  {
    id: '17',
    name: 'Disjoncteur de puissance Siemens SIRIUS 3RV2011-1CA10  1,8----2,5A',
    nameAr: 'Disjoncteur de puissance Siemens SIRIUS 3RV2011-1CA10  1,8----2,5A',
    reference: '3RV2011-1CA10',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 1078,
  ...
  {
    id: '18',
    name: 'Disjoncteur de puissance Siemens SIRIUS 3RV2011-1PA10   1,4----2A',
    nameAr: 'Disjoncteur de puissance Siemens SIRIUS 3RV2011-1PA10   1,4----2A',
    reference: '3RV2011-1PA10',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 979,
  ...
  {
    id: '19',
    name: 'Auxiliaire transversales Bornes à vis 1 NO +1 NF pour disjoncteur 3RV2',
    nameAr: 'Auxiliaire transversales Bornes à vis 1 NO +1 NF pour disjoncteur 3RV2',
    reference: '3RV2901',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 99,
  ...
  {
    id: '20',
    name: 'Endress+Hauser Promag 53P80, DN80 3″ 53P80-ER1B1RC2BBAA',
    nameAr: 'Endress+Hauser Promag 53P80, DN80 3″ 53P80-ER1B1RC2BBAA',
    reference: '53P80, DN80',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 16500,
    image: '/products/image20.jpeg',
  ...
  {
    id: '22',
    name: 'Jeux de Garniture mécanique',
    nameAr: 'Jeux de Garniture mécanique',
    reference: 'Garniture',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 1650,
  ...
  {
    id: '23',
    name: 'ALLEN-BRADLEY MICROLOGIX 1000 1761-L32BWA SERIES E PLC Used',
    nameAr: 'ALLEN-BRADLEY MICROLOGIX 1000 1761-L32BWA SERIES E PLC Used',
    reference: '1761-L32BWA',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
  ...
  {
    id: '24',
    name: '1762-L24BXB Factory Sealed AB MicroLogix 1200 24 Point Controller',
    nameAr: '1762-L24BXB Factory Sealed AB MicroLogix 1200 24 Point Controller',
    reference: '1762-L24BXB',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 110,
    image: '/products/image24.jpeg',
  ...
  {
    id: '25',
    name: '1762-IF2OF2 1762-IF20F2 Allen Bradley Analog I/O Module  Used',
    nameAr: '1762-IF2OF2 1762-IF20F2 Allen Bradley Analog I/O Module  Used',
    reference: '1762-IF2OF2',
    category: 'modules',
    categoryAr: 'وحدات وتوصيلات',
    price: 550,
  ...
  {
    id: '26',
    name: 'ALLEN-BRADLEY PLC 5 1785-L40C15 ControlNet PLC-5 Processor PROCESSOR MODULE Used',
    nameAr: 'ALLEN-BRADLEY PLC 5 1785-L40C15 ControlNet PLC-5 Processor PROCESSOR MODULE Used',
    reference: '1785-PLC-5/40C',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 13200,
  ...
  {
    id: '27',
    name: 'ALLEN-BRADLEY 4 SLOT I/O CHASIS  Used',
  ...
  {
    id: '28',
    name: 'Power Supplay PLC 5 220VAC  Used',
    nameAr: 'Power Supplay PLC 5 220VAC  Used',
    reference: '1771-P7',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 2200,
    image: '/products/image28.jpeg',
  ...
  {
    id: '29',
    name: 'Allen-Bradley carte INPUT 1771-IB',
    nameAr: 'Allen-Bradley carte INPUT 1771-IB',
    reference: '1771 IB16',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image29.jpeg',
  ...
  {
    id: '30',
    name: 'Allen-Bradley carte Output 1771-OB',
    nameAr: 'Allen-Bradley carte Output 1771-OB',
    reference: '1771-OB16',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
  ...
  {
    id: '31',
    name: 'Allen-Bradley carte Analogue INPUT 1771-',
    nameAr: 'Allen-Bradley carte Analogue INPUT 1771-',
    reference: '1771-IFE',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image31.jpeg',
  ...
  {
    id: '32',
    name: 'Allen-Bradley 1746-A4 SLC 500 4 Slot Modular I/O Chassis for 1746 I/O Modules',
    nameAr: 'Allen-Bradley 1746-A4 SLC 500 4 Slot Modular I/O Chassis for 1746 I/O Modules',
    reference: '1746-A4',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1430,
    image: '/products/image32.jpeg',
  ...
  {
    id: '33',
    name: 'Allen-Bradley 1746-BAS Basic Module',
    nameAr: 'Allen-Bradley 1746-BAS Basic Module',
    reference: '1746-BAS',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 616,
  ...
  {
    id: '34',
    name: '1746-ni4 Ser a SLC 500 Analog Input Module Allen-bradley',
    nameAr: '1746-ni4 Ser a SLC 500 Analog Input Module Allen-bradley',
    reference: '1746-NI4',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1397,
    image: '/products/image34.jpeg',
  ...
  {
    id: '35',
    name: 'New Allen-Bradley AB 1747-L532 /D SLC 500 SLC 5/03 CPU Processor Unit 1747L532',
    nameAr: 'New Allen-Bradley AB 1747-L532 /D SLC 500 SLC 5/03 CPU Processor Unit 1747L532',
    reference: '1747-L532',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1650,
    image: '/products/image35.jpeg',
  ...
  {
    id: '36',
    name: 'SLC 16 Point DC Input Module',
    nameAr: 'SLC 16 Point DC Input Module',
    reference: '1746-IB16',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image36.jpeg',
  ...
  {
    id: '37',
    name: '1746-Output Triac 220VAC',
    nameAr: '1746-Output Triac 220VAC',
    reference: '1746-OA16 /A',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image37.jpeg',
  ...
  {
    id: '38',
    name: 'Allen Bradley SLC 500 ,1746-P2 Ser C ,Power Supply Module  Used',
    nameAr: 'Allen Bradley SLC 500 ,1746-P2 Ser C ,Power Supply Module  Used',
    reference: '1746-P2',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 165,
    image: '/products/image38.jpeg',
  ...
  {
    id: '39',
    name: 'Schassis Contrologix 4 Slots',
    nameAr: 'Schassis Contrologix 4 Slots',
    reference: '1756-A4',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
    image: '/products/image39.jpeg',
  ...
  {
    id: '40',
    name: 'ALLEN BRADLEY 1756-PA75R 24VDC 110W CONTROLOGIX DC REDUNDANT POWER SUPPLY',
    nameAr: 'ALLEN BRADLEY 1756-PA75R 24VDC 110W CONTROLOGIX DC REDUNDANT POWER SUPPLY',
    reference: '1756-PA',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
    image: '/products/image40.jpeg',
  ...
  {
    id: '41',
    name: 'yco Contrôle Thermique Digitrace MONI PT100 EXE Température Sonde /',
    nameAr: 'yco Contrôle Thermique Digitrace MONI PT100 EXE Température Sonde /',
    reference: 'MONI PT100 EXE',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 1100,
  ...
  {
    id: '42',
    name: 'E32-CC200 2M Omron Fiber Sensor, For Industrial Omron',
    nameAr: 'E32-CC200 2M Omron Fiber Sensor, For Industrial Omron',
    reference: 'E32-DC200 2M',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 220,
    image: '/products/image42.jpeg',
  ...
  {
    id: '43',
    name: 'CABLE FIBRE OPTIQUE 6FO ARMEE OM3',
    nameAr: 'CABLE FIBRE OPTIQUE 6FO ARMEE OM3',
    reference: '6x50x125',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 66,
    image: '/products/image43.jpeg',
  ...
  {
    id: '44',
    name: 'Simatic Tp1200 Comfort Panel Touch Operation 12 Inches Widescreen TFT Display Ne',
    nameAr: 'Simatic Tp1200 Comfort Panel Touch Operation 12 Inches Widescreen TFT Display Ne',
    reference: '6AV2124-OMC01',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 27500,
  ...
  {
    id: '45',
    name: 'Palazzoli 579826 - topTER con portella trasparente alta capienza per installazio',
    nameAr: 'Palazzoli 579826 - topTER con portella trasparente alta capienza per installazio',
    reference: '579826 PALAZOLI',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 638,
    image: '/products/image45.jpeg',
  ...
  {
    id: '46',
    name: 'Chemin de câble en tôle INGELEC 63x33',
    nameAr: 'Chemin de câble en tôle INGELEC 63x33',
    reference: 'Ingelec 63*33',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 110,
  ...
  {
    id: '47',
    name: 'Chemin de câble en tôle INGELEC 100x63',
    nameAr: 'Chemin de câble en tôle INGELEC 100x63',
    reference: 'Ingelec 100*63',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 165,
    image: '/products/image47.jpeg',
  ...
  {
    id: '48',
    name: 'Chemin de cable PVC 300*100 AVEC Cache',
    nameAr: 'Chemin de cable PVC 300*100 AVEC Cache',
    reference: 'GS400X60',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 1100,
    image: '/products/image48.jpeg',
  ...
  {
    id: '49',
    name: 'Boite ATEX Stahel 600*600',
    nameAr: 'Boite ATEX Stahel 600*600',
    reference: 'STAHL 81461083',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 3850,
    image: '/products/image49.jpeg',
  ...
  {
    id: '50',
    name: 'PanelView Plus 6 1500 Touch  ONLY SCREEN old',
    nameAr: 'PanelView Plus 6 1500 Touch  ONLY SCREEN old',
    reference: '2711P-RDT15C',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 1650,
    image: '/products/image50.jpeg',
  ...
  {
    id: '51',
    name: 'Panel View plus key board new screen',
    nameAr: 'Panel View plus key board new screen',
    reference: '2711P-RDK10C',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 2750,
    image: '/products/image51.jpeg',
  ...
  {
    id: '52',
    name: 'Operator Panel OP170B MONO 6AV6542-0BB15-2AX0 NOT FONCTION',
    nameAr: 'Operator Panel OP170B MONO 6AV6542-0BB15-2AX0 NOT FONCTION',
    reference: 'OP170B',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 55,
  ...
  {
    id: '53',
    name: 'Input Module 16 New',
    nameAr: 'Input Module 16 New',
    reference: '1746-IM16',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
    image: '/products/image53.jpeg',
  ...
  {
    id: '54',
    name: 'Intpout module Contrologix new',
    nameAr: 'Intpout module Contrologix new',
    reference: '1756IB16D',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
    image: '/products/image54.jpeg',
  ...
  {
    id: '55',
    name: 'Output Carte Contrologix new',
    nameAr: 'Output Carte Contrologix new',
    reference: '1756PB16E',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
  ...
  {
    id: '56',
    name: 'Carte servo drive new',
    nameAr: 'Carte servo drive new',
    reference: '1756MOSE',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
  ...
  {
    id: '57',
    name: 'ABB 1SFA899003R1000 PSTEK EXTERNAL KEYPAD',
    nameAr: 'ABB 1SFA899003R1000 PSTEK EXTERNAL KEYPAD',
    reference: '1SFA899003R1000',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 1100,
    image: '/products/image3.jpeg',
  ...
  {
    id: '58',
    name: 'Contact auxiliaire Allen Bradley 100-SB10, 1NO (NEUF DANS SA BOÎTE)',
    nameAr: 'Contact auxiliaire Allen Bradley 100-SB10, 1NO (NEUF DANS SA BOÎTE)',
    reference: '100-SB100',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 55,
  ...
  {
    id: '59',
    name: 'Contact auxiliaire Allen Bradley 100-FA10, 1NO (NEUF DANS SA BOÎTE)',
    nameAr: 'Contact auxiliaire Allen Bradley 100-FA10, 1NO (NEUF DANS SA BOÎTE)',
    reference: '100-FA10',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 55,
  ...
  {
    id: '60',
    name: 'Circuit breaker size S00 for motor protection, CLASS 10 A-release 0.9...1.25 A',
    nameAr: 'Circuit breaker size S00 for motor protection, CLASS 10 A-release 0.9...1.25 A',
    reference: 'SRV1011-0KA10',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 880,
    image: '/products/image6.jpeg',
  ...
  {
    id: '61',
    name: 'Allen-Bradley 2711P-RN6 PanelView Plus DH/RIO/DH-485 Communication module',
    nameAr: 'Allen-Bradley 2711P-RN6 PanelView Plus DH/RIO/DH-485 Communication module',
    reference: 'AB Carte DH+/DH485/RIO',
    category: 'modules',
    categoryAr: 'وحدات وتوصيلات',
    price: 2200,
    image: '/products/image7.jpeg',
  ...
  {
    id: '62',
    name: '1756-A4 Allen Bradley - ControlLogix Chassis 4-Slot Rack',
    nameAr: '1756-A4 Allen Bradley - ControlLogix Chassis 4-Slot Rack',
    reference: '1756-A4',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 2200,
  ...
  {
    id: '63',
    name: '1746 A4 SLC 4 Slots Chassis  USED',
    nameAr: '1746 A4 SLC 4 Slots Chassis  USED',
    reference: '1746A4',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
  ...
  {
    id: '64',
    name: 'Alimentation automate Allen Bradley 1746 pour Série SLC 500  USED',
    nameAr: 'Alimentation automate Allen Bradley 1746 pour Série SLC 500  USED',
    reference: '1746 P2',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
  ...
  {
    id: '65',
    name: 'Allen-Bradley SLC 500 Processor Unit 1746-L532 USED',
    nameAr: 'Allen-Bradley SLC 500 Processor Unit 1746-L532 USED',
    reference: '1746 L531',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
  ...
  {
    id: '66',
    name: 'Processor Unit 1747-L543 Allen-Bradley SLC500 Series C *Used*',
    nameAr: 'Processor Unit 1747-L543 Allen-Bradley SLC500 Series C *Used*',
    reference: '1747-L543',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
  ...
  {
    id: '67',
    name: 'PLC Input Module 1746-IB16 Allen-Bradley SLC500 SER C 10-30VDC 1746-IB16 *Used*',
    nameAr: 'PLC Input Module 1746-IB16 Allen-Bradley SLC500 SER C 10-30VDC 1746-IB16 *Used*',
    reference: '1746-IB16',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 44,
  ...
  {
    id: '68',
    name: '1746-NI4 Analog Input Module SLC 500 USED',
  ...
  {
    id: '69',
    name: 'Output Module 1746-OB16 Allen Bradley SLC500 SER D 10-30Vdc 1746OB16 *Used*',
    nameAr: 'Output Module 1746-OB16 Allen Bradley SLC500 SER D 10-30Vdc 1746OB16 *Used*',
    reference: '1746OB16',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
  ...
  {
    id: '70',
    name: 'Allen Bradley 1746-L532 SLC500 Processor CPU Unit',
    nameAr: 'Allen Bradley 1746-L532 SLC500 Processor CPU Unit',
    reference: '1746-L532',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
  ...
  {
    id: '71',
    name: '1746-OB8 SLC 500 PLC Module 1746-OB8 Output',
    nameAr: '1746-OB8 SLC 500 PLC Module 1746-OB8 Output',
    reference: '1746-OB8',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
  ...
  {
    id: '72',
    name: 'Allen-Bradley 1771-IFE PLC-5 Analog Input Module',
    nameAr: 'Allen-Bradley 1771-IFE PLC-5 Analog Input Module',
    reference: '1771-IFE',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
  ...
  {
    id: '73',
    name: 'Rail de montage Siemens S7-300 pour Série SIMATIC S7-300',
    nameAr: 'Rail de montage Siemens S7-300 pour Série SIMATIC S7-300',
    reference: 'RACK S7/300',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 220,
    image: '/products/image19.jpeg',
  ...
  {
    id: '74',
    name: '6ES7312-1AE14-0AB0 Siemens S7-300, CPU 312 CPU WITH MPI INTERFACE, USED',
    nameAr: '6ES7312-1AE14-0AB0 Siemens S7-300, CPU 312 CPU WITH MPI INTERFACE, USED',
    reference: '6ES7312-1AE14-0AB0',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image20.jpeg',
  ...
  {
    id: '75',
    name: 'INPUT MODULE SM 321 DI 32x24V DC',
    nameAr: 'INPUT MODULE SM 321 DI 32x24V DC',
    reference: '6ES7 321-1BL00-0AA0',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image21.jpeg',
  ...
  {
    id: '76',
    name: 'connecteurs BUS Siemens 720 2001-01 PIS',
    nameAr: 'connecteurs BUS Siemens 720 2001-01 PIS',
    reference: '720 2001-01',
    category: 'modules',
    categoryAr: 'وحدات وتوصيلات',
    price: 22,
    image: '/products/image22.jpeg',
  ...
  {
    id: '77',
    name: 'SYSTEM HELMHOLZ 700-322-1BH01 S7-DEA DO 16X DC24V - 0.5A USED',
    nameAr: 'SYSTEM HELMHOLZ 700-322-1BH01 S7-DEA DO 16X DC24V - 0.5A USED',
    reference: '700-322-1BH01',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image23.jpeg',
  ...
  {
    id: '78',
    name: 'YSTEME HELMHOLZ 700-321-1BH02 S7-DEA Di 16x DC24V',
    nameAr: 'YSTEME HELMHOLZ 700-321-1BH02 S7-DEA Di 16x DC24V',
    reference: '700-321-1BH02',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image24.jpeg',
  ...
  {
    id: '79',
    name: 'MODULE D\'ENTRÉE NUMÉRIQUE SIMATIC 6ES7 321-1BL00-0AA0 SIMATIC 6ES73211BL000AA0',
    nameAr: 'MODULE D\'ENTRÉE NUMÉRIQUE SIMATIC 6ES7 321-1BL00-0AA0 SIMATIC 6ES73211BL000AA0',
    reference: '6ES7 321-1BL00',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image25.jpeg',
  ...
  {
    id: '80',
    name: 'Module de sortie Siemens 6ES7 322-1HH00-0AA0',
    nameAr: 'Module de sortie Siemens 6ES7 322-1HH00-0AA0',
    reference: '6ES7 322-1HH00',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
    image: '/products/image26.jpeg',
  ...
  {
    id: '81',
    name: 'Siemens 6ES7322-5HB01-0AB0 6ES7 322-5HB01-0AB0 USED',
    nameAr: 'Siemens 6ES7322-5HB01-0AB0 6ES7 322-5HB01-0AB0 USED',
    reference: '6ES7322-5HB01',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
    image: '/products/image27.jpeg',
  ...
  {
    id: '82',
    name: 'Module d\'entrée analogique Helmholz 700-331-1KF01 AEA  USED',
    nameAr: 'Module d\'entrée analogique Helmholz 700-331-1KF01 AEA  USED',
    reference: '700-331-1KF01',
    category: 'modules',
    categoryAr: 'وحدات وتوصيلات',
    price: 550,
    image: '/products/image28.jpeg',
  ...
  {
    id: '83',
    name: 'Alimentation Siemens SIMATIC PM 1207 6EP1332-1SH71 État du produit:01 -inutilisé',
    nameAr: 'Alimentation Siemens SIMATIC PM 1207 6EP1332-1SH71 État du produit:01 -inutilisé',
    reference: 'PM 1207',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 330,
  ...
  {
    id: '84',
    name: 'Siemens CPU 1215C - 6ES7215-1AG40-0XB0  -inutilisée/emballage d\'origine-',
    nameAr: 'Siemens CPU 1215C - 6ES7215-1AG40-0XB0  -inutilisée/emballage d\'origine-',
    reference: 'CPU 1215C',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 3300,
  ...
  {
    id: '85',
    name: 'Module PLC Siemens S7-1200 Sm1222  6es7223-1pl32-0xb0  inutilisée/emballage d\'or',
    nameAr: 'Module PLC Siemens S7-1200 Sm1222  6es7223-1pl32-0xb0  inutilisée/emballage d\'or',
    reference: '6ES7223-1PL32-0XB0',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 1100,
    image: '/products/image31.jpeg',
  ...
  {
    id: '86',
    name: 'LOGO! 12/24RCE,logic module,display PS/I/O: 12/24VDC/relay, 8 DI (4AI)/4DO, memo',
    nameAr: 'LOGO! 12/24RCE,logic module,display PS/I/O: 12/24VDC/relay, 8 DI (4AI)/4DO, memo',
    reference: '6ED1052-1MD00-0BA8',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 715,
    image: '/products/image32.jpeg',
  ...
  {
    id: '87',
    name: '1794-TB3 Flex Terminal Base  USED',
    nameAr: '1794-TB3 Flex Terminal Base  USED',
    reference: '1794-TB3',
    category: 'modules',
    categoryAr: 'وحدات وتوصيلات',
    price: 220,
  ...
  {
    id: '88',
    name: 'Allen-Bradley 1794-IB16 24 VDC Sink Input - 1794-IB16-A-B01  USED',
    nameAr: 'Allen-Bradley 1794-IB16 24 VDC Sink Input - 1794-IB16-A-B01  USED',
    reference: '1794-IB16',
    category: 'modules',
    categoryAr: 'وحدات وتوصيلات',
    price: 220,
  ...
  {
    id: '89',
    name: '1794-OB16 Flex 16 Point Digital Output Module   USED',
    nameAr: '1794-OB16 Flex 16 Point Digital Output Module   USED',
    reference: '1794-OB16',
    category: 'modules',
    categoryAr: 'وحدات وتوصيلات',
    price: 330,
  ...
  {
    id: '90',
    name: 'Siemens 6ES5095-8MB02 CPU S5-95U MODULE SIMATIC S5   USED',
    nameAr: 'Siemens 6ES5095-8MB02 CPU S5-95U MODULE SIMATIC S5   USED',
    reference: '6ES5095-8MB02',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image36.jpeg',
  ...
  {
    id: '91',
    name: 'IEMENS SIMATIC S5 6ES5 440-8MA21 DIGITAL OUTPUT MODULE   USED',
    nameAr: 'IEMENS SIMATIC S5 6ES5 440-8MA21 DIGITAL OUTPUT MODULE   USED',
    reference: '6ES5 440-8MA21',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 550,
    image: '/products/image37.jpeg',
  ...
  {
    id: '92',
    name: 'Siemens Simatic S5 6ES5 700-8MA11 Bus Module   USED',
    nameAr: 'Siemens Simatic S5 6ES5 700-8MA11 Bus Module   USED',
    reference: '6ES5 700-8MA11',
    category: 'plc',
    categoryAr: 'أتمتة وتحكم',
    price: 110,
    image: '/products/image38.jpeg',
  ...
  {
    id: '93',
    name: 'Colonne de signalisation; /vert/jaune; LED; 24VDC; 24VAC SANS TIGE  new',
    nameAr: 'Colonne de signalisation; /vert/jaune; LED; 24VDC; 24VAC SANS TIGE  new',
    reference: 'IK73L024XM01',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 110,
    image: '/products/image39.jpeg',
  ...
  {
    id: '94',
    name: 'Elematic ELEFIX 16-32  new',
    nameAr: 'Elematic ELEFIX 16-32  new',
    reference: '565958(M7)',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 2,
  ...
  {
    id: '95',
    name: 'Contacteur de puissance, AC-3 9 A, 4 kW / 400 V 1 NO, 24 V CC 3 pôles,  new',
    nameAr: 'Contacteur de puissance, AC-3 9 A, 4 kW / 400 V 1 NO, 24 V CC 3 pôles,  new',
    reference: '3RT1016-1BB41',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 220,
    image: '/products/image41.jpeg',
  ...
  {
    id: '96',
    name: 'Relaisn Declencheur Siemens  new',
    nameAr: 'Relaisn Declencheur Siemens  new',
    reference: '3RV1902-1AB0',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 550,
    image: '/products/image42.jpeg',
  ...
  {
    id: '97',
    name: 'ON DELAY time relay, 2-channels SJR-2  new',
    nameAr: 'ON DELAY time relay, 2-channels SJR-2  new',
    reference: 'SJR2',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 110,
  ...
  {
    id: '98',
    name: 'Disjoncteur de protection moteur série Gv2 20-25 A  new',
    nameAr: 'Disjoncteur de protection moteur série Gv2 20-25 A  new',
    reference: 'GV2ME22',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 198,
  ...
  {
    id: '99',
    name: 'DÉCLENCHEUR VOLTMÉTRIQUE - TESYS GV - 24V AC - SCHNEIDER ELECTRIC GVAS025  new',
    nameAr: 'DÉCLENCHEUR VOLTMÉTRIQUE - TESYS GV - 24V AC - SCHNEIDER ELECTRIC GVAS025  new',
    reference: 'GVAS025',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 220,
  ...
  {
    id: '100',
    name: '375010Ingelec Telerrupteur new',
    nameAr: '375010Ingelec Telerrupteur new',
    reference: '375010',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 110,
  ...
  {
    id: '101',
    name: 'Contacteur Schneider LC1D40AQ7 new',
    nameAr: 'Contacteur Schneider LC1D40AQ7 new',
    reference: 'LC1D40AQ7',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 935,
  ...
  {
    id: '102',
    name: 'Interrupteur Schneider 63A INS63 new',
    nameAr: 'Interrupteur Schneider 63A INS63 new',
    reference: 'ins63 Schneider',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 330,
    image: '/products/image48.jpeg',
  ...
  {
    id: '103',
    name: 'BMeters 2" BSP (50mm) GMDM-i Multi Jet Cold Water Meter, PN: GMDM-50AF  NEW',
    nameAr: 'BMeters 2" BSP (50mm) GMDM-i Multi Jet Cold Water Meter, PN: GMDM-50AF  NEW',
    reference: 'GMDM DN50',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 2200,
  ...
  {
    id: '104',
    name: 'Capteur de proximité Omron, M12, Détection 4 mm, PNP NO, 12→24 V c.c',
    nameAr: 'Capteur de proximité Omron, M12, Détection 4 mm, PNP NO, 12→24 V c.c',
    reference: 'E2A-M12KS04',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 110,
    image: '/products/image50.jpeg',
  ...
  {
    id: '105',
    name: 'Capteur de proximité Omron, M08, Détection 4 mm, PNP NO, 12→24 V c.c',
    nameAr: 'Capteur de proximité Omron, M08, Détection 4 mm, PNP NO, 12→24 V c.c',
    reference: 'E2A-M08KS02',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 110,
    image: '/products/image51.jpeg',
  ...
  {
    id: '106',
    name: 'SCHNEIDER ZCP21M12 LIMIT SWITCH',
    nameAr: 'SCHNEIDER ZCP21M12 LIMIT SWITCH',
    reference: 'ZCP21M12',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 110,
  ...
  {
    id: '107',
    name: 'Capteur photoélectrique Omron E3X-NA11',
    nameAr: 'Capteur photoélectrique Omron E3X-NA11',
    reference: 'E3X-NA11',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 110,
  ...
  {
    id: '108',
    name: 'LADN22 Schneider Electric auxiliary contact block',
    nameAr: 'LADN22 Schneider Electric auxiliary contact block',
    reference: 'LADN22',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 55,
  ...
  {
    id: '109',
    name: 'TELEMECANIQUE ZB2BZ105, 061434, Push button body with switches',
    nameAr: 'TELEMECANIQUE ZB2BZ105, 061434, Push button body with switches',
    reference: 'ZB2BZ105',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 55,
  ...
  {
    id: '110',
    name: 'Harmony XB5 - voyant lumineux BA9s - Ø22 - blanc - direct 250V max - vis étrier',
    nameAr: 'Harmony XB5 - voyant lumineux BA9s - Ø22 - blanc - direct 250V max - vis étrier',
    reference: 'XB5 AV61',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 55,
  ...
  {
    id: '111',
    name: '1/2\'\' UW-15 Uni-D Type Brass Solenoid Valve 220VAC',
    nameAr: '1/2\'\' UW-15 Uni-D Type Brass Solenoid Valve 220VAC',
    reference: '1/2\'\' UW-15',
    category: 'electrical',
    categoryAr: 'كهرباء صناعية',
    price: 110,
  ...
  {
    id: '112',
    name: 'Connecteur résistant à 32 broches PG29 Mâle Femelle Butt-Joint H32A Shell Hasp H',
    nameAr: 'Connecteur résistant à 32 broches PG29 Mâle Femelle Butt-Joint H32A Shell Hasp H',
    reference: 'PG29 H32A',
    category: 'modules',
    categoryAr: 'وحدات وتوصيلات',
    price: 110,
  ...
  {
    id: '113',
    name: 'Capacitive proximity sensor AKS18/4609S',
    nameAr: 'Capacitive proximity sensor AKS18/4609S',
    reference: 'AKS18/4609S',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 55,
    image: '/products/image5.jpeg',
  ...
  {
    id: '114',
    name: 'ISCH TE-2000PS INDUSTRIAL HYGIENE ENZYME SAMPLER 110V-AC D532586',
    nameAr: 'ISCH TE-2000PS INDUSTRIAL HYGIENE ENZYME SAMPLER 110V-AC D532586',
    reference: 'TISCH ENVIREMENT',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 220,
    image: '/products/image6.jpeg',
  ...
  {
    id: '115',
    name: 'MARANTEC CS310 - Armoire de commande pour moteurs mono ou triphasés',
    nameAr: 'MARANTEC CS310 - Armoire de commande pour moteurs mono ou triphasés',
    reference: 'CS310',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 1100,
  ...
  {
    id: '116',
    name: 'Notifier NFS 8 Zone Conventional Fire Alarm Panel',
    nameAr: 'Notifier NFS 8 Zone Conventional Fire Alarm Panel',
    reference: 'NFS 2-8',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 1100,
  ...
  {
    id: '117',
    name: 'KL731KELSEN  Sans Support',
    nameAr: 'KL731KELSEN  Sans Support',
    reference: 'KL731',
    category: 'equipment',
    categoryAr: 'معدات متنوعة',
    price: 110,
  ...
  {
    id: '118',
    name: 'SICK WS36-D430 THROUGH-BEAM PHOTOELECTRIC SENSOR avec Recipteur',
    nameAr: 'SICK WS36-D430 THROUGH-BEAM PHOTOELECTRIC SENSOR avec Recipteur',
    reference: 'SICK WS36-D430',
    category: 'sensors',
    categoryAr: 'حساسات وكاشفات',
    price: 110,
    image: '/products/image10.jpeg',
  ...
  {
    id: '119',
    name: 'Optical Patchcord SC UPC/SC UPC Duplex',
    nameAr: 'Optical Patchcord SC UPC/SC UPC Duplex',
    reference: 'sc_upc',
    category: 'modules',
    categoryAr: 'وحدات وتوصيلات',
    price: 55,
