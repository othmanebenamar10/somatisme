...
export default function Products() {
  ...
  const generateInvoice = (orderItems: any[], orderInfo: any, total: number) => {
    ...
    doc.text('06 79 82 56 46  |  somatisme@gmail.com  |  www.somatisme.ma', 15, 43);
    ...
    doc.text('Contact: 06 79 82 56 46', 15, y + 29);
    ...
    doc.setTextColor(203, 213, 225);
    doc.setFont('helvetica', 'normal');
    doc.text('Équipements Industriels  |  06 79 82 56 46  |  somatisme@gmail.com', 105, 286, { align: 'center' });
  ...
  const handleOrderSubmit = async () => {
    ...
    try {
      ...
      doc.text('06 79 82 56 46  |  somatisme@gmail.com  |  www.somatisme.ma', 12, 44);
      ...
      doc.text('Contact: 06 79 82 56 46', col1, botY + 32);
      ...
      doc.setFont('helvetica', 'normal');
      doc.text('Equipements Industriels  |  06 79 82 56 46  |  somatisme@gmail.com', 105, fY + 14, { align: 'center' });
